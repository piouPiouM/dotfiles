nnoremap <silent> <leader><Space> :Telescope find_files cwd=%:p:h hidden=true<CR>
nnoremap <silent> <leader>e :Telescope file_browser<CR>
nnoremap <silent> <leader>f :Telescope live_grep hidden=true<CR>
...
nnoremap <silent> <leader>w :Telescope grep_string<CR>
