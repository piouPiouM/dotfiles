...
describe("Functions", function()
  ...
  describe("pipeables", function()
    ...
    describe("format()", function()
      it("should format with a single replacement", function()
        local actual = pipe("B", Module.format("A%sC"))
        assert.are.same("ABC", actual)
      end)

      it("should format multiple replacements", function()
        local actual = pipe({ "B", "D" }, Module.format("A%sC%s"))
        assert.are.same("ABCD", actual)
      end)
    end)
  end)
end)